...
export default function VerifyCredentialPage() {
  ...
  useEffect(() => {
    const fetchCredential = async () => {
      ...
      try {
        const response = await fetch(`/api/credential/verify/${encodeURIComponent(identifier)}`);
      ...
      <main className="container max-w-4xl mx-auto px-4 py-12">
        <div className="space-y-8">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground max-w-2xl">
                This credential has been verified on the Sui blockchain. The holder has successfully 
                completed all Suilings exercises and earned this achievement.
              </p>
            </div>
          </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    This credential is permanently stored on the Sui blockchain and cannot be altered or faked.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    This credential is non-transferable and permanently linked to the recipient&apos;s wallet.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    The holder has completed all 82 Suilings exercises, demonstrating proficiency in Sui Move programming.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <div className="text-center space-y-4">
            <p className="text-muted-foreground">
              Want to earn your own credential?
            </p>
