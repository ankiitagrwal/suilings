// Exercise: Object Transfer and Ownership
//
// Implement object transfers, sharing, and freezing in Sui.
//
...
/// Freezes a card making it immutable
...
module suilings::objects2_tests {
    ...
    #[test]
    fun mint_and_transfer_nft_works() {
    let addr1 = @0xA;
    let addr2 = @0xB;
    ...
    {
    assert!(test_scenario::has_most_recent_for_address<objects2::NFT>(addr2));
    };
...
// Increment it
        ...
        assert!(objects2::counter_value(&counter) == 1);

        objects2::increment_counter(&mut counter);
        assert!(objects2::counter_value(&counter) == 2);
