// Exercise: Transaction Context - Time-Locked Escrow
//
// Build an escrow system with time locks using epoch-based constraints.
// Use fresh_object_address for unique escrow IDs and epoch timing for releases.
//
...
/// Get escrow info
public fun escrow_info(escrow: &Escrow): (address, address, address, u64, u64, u64, u8, bool, bool) {
...
fun test_create_escrow() {
    ...
    test_scenario::next_tx(&mut scenario, depositor);
    {
        ...
        let (_, dep, ben, amount, unlock, created, conditions, approved, released) = tx_context3::escrow_info(&escrow);
